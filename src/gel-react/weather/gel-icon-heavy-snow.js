...
exports.default = function () {
  return react.createElement(
    'svg',
    { className: 'gel-icon gel-icon-heavy-snow', xmlns: 'http://www.w3.org/2000/svg', width: '32', height: '32', viewBox: '0 0 32 32' },
    ...
    react.createElement(
      'g',
      { fill: '#A8A8A8' },
      react.createElement('path', { d: 'M12.1 24.2l-3.4-3.5.7-.7 3.4 3.5-.7.7z' }),
