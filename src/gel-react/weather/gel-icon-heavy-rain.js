...
exports.default = function () {
  return react.createElement(
    'svg',
    { className: 'gel-icon gel-icon-heavy-rain', xmlns: 'http://www.w3.org/2000/svg', width: '32', height: '32', viewBox: '0 0 32 32' },
    ...
    react.createElement(
      'g',
      { fill: '#68A5D8' },
      react.createElement('path', { d: 'M11.6 24.1l.4-4.7-4 2.3c-.7.4-1.2 1.2-1.2 2.1 0 1.3 1.1 2.4 2.4 2.4 1.3.1 2.3-.9 2.4-2.1zM18.2 18.4l.4-4.7-4 2.3c-.7.4-1.2 1.2-1.2 2.1 0 1.3 1.1 2.4 2.4 2.4 1.2.1 2.2-.9 2.4-2.1z' })
    )
  )
}
